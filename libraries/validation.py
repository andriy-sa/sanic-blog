...
class Validation():
    ...
    error_message_templates = {
        "after": "This field is an invalid after date",
        "alpha": "This field can have only alphabets",
        "alpha_num": "This field can have only alphabets or numbers",
        "before": "This field is an invalid before date ",
        "between": "This field has an invalid value for between field",
        "boolean": "This field has invalid value for boolean field",
        "confirmed": "This field must have a pair field",
        "date": "This field value does not match date format",
        "digits": "This field must be an integer",
        "different": "This field has invalid value for same rule ",
        "email": "This field must be a valid email address",
        "in": "This field has invalid value for in rule",
        "ip": "This field must be a valid IP address",
        "max": "The maximum value for the field is invalid",
        "min": "The minimum value for the field is invalid",
        "not_in": "This field has invalid value for not_in rule",
        "present": "The data dictionary must have a nullable field name",
        "phone": "This field must be a valid Phone Number",
        "regex": "This field does not match the RE",
        "required": "This field must be filled",
        "same": "This field has invalid value for same rule",
        "size": "This field has invalid value for size rule",
        "website": "This field must be a valid Website URL",
    ...
    def __validate_min_fields(self, data, field_name, rule):
        ...
        errs = []
        if data.get(field_name).isdigit():
            if int(data.get(field_name)) < min_value:
                errs.append(self.return_field_message(field_name, "min"))
        else:
            if len(data.get(field_name)) < min_value:
                errs.append(self.return_field_message(field_name, "min"))
    ...
    def return_field_message(self, field_name, rule_name):
        return {
            field_name: [self.error_message_templates[rule_name]]
        }
